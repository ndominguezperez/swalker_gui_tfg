...
window.onload = function() {
  ...
  $("#EMG_tab2").on("shown.bs.tab", function (event) {
    ...
    ctx_emg_envelope_data_objects = [
      ctxrfrightInstance.data.datasets[0],
      ctxbfrightInstance.data.datasets[0],
      ctxtarightInstance.data.datasets[0],
      ctxgmrightInstance.data.datasets[0],
      ctxrfleftInstance.data.datasets[0],
      ctxbfleftInstance.data.datasets[0],
      ctxtaleftInstance.data.datasets[0],
      ctxgmleftInstance.data.datasets[0],
    ];
  ...
  var ctx_emg_real_data_objects = [
    ctxrhipInstance.data.datasets[1],
    ctxrhipInstance.data.datasets[2],
    ctxlhipInstance.data.datasets[1],
    ctxlhipInstance.data.datasets[2],
  ];
  var ctx_rom_data_objects = [
    ctxrhipInstance.data.datasets[0],
    ctxlhipInstance.data.datasets[0],
  ];
            ...
            function myClock() {
              ...
              if (c == 0) {
                ...
                document.getElementById("start_stop").style.borderColor =
                  "#09c768";
                document.getElementById("observations_div").style.display =
                  "block";
              }
            }
          }
  ...
  $arrow_right.onclick = () => {
    if (is_swalker_connected) {
      document.getElementById("direction_html").innerHTML =
      ...
      $arrow_right.animate([{ left: "0" }, { left: "10px" }, { left: "0" }], {
        duration: 700,
        iterations: 1,
      });
    } else {
  ...
  $arrow_left.onclick = () => {
    if (is_swalker_connected) {
      ...
      $arrow_left.animate([{ left: "0" }, { left: "10px" }, { left: "0" }], {
        duration: 700,
        iterations: 1,
      });
    } else {
